...
-- 3. INTERSECT (8.0.31 이상에서 추가, 교집합)
-- 두 select 문의 결과 중 공통 되는 레코드(행)만 반환한다.
SELECT
    menu_code,
    menu_name,
    menu_price,
...
-- 4. EXCEPT (차집합)
-- 첫 번째 select 문의 결과에서 두 번째 select 문의 결과에 포함 되는 레코드를 제외한 결과 반환
